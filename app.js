...
const aboutme = [
 `Hi I am Sayon, Welcome to my project please review and comment a fix  I'm open to new idea`,
];
...
// resetting the value of my quote to aboutme 
reset.addEventListener('click', function(){
         for (let i = 0; i === aboutme.length; i++)
          // console log the value of aboutme 
  console.log(aboutme)
  // Update the quotes text content to the value of aboutme 
    quotes.textContent = aboutme;
